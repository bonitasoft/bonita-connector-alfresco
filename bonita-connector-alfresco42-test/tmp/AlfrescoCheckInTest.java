 ...
 * @author Yanyan Liu
 */
public class AlfrescoCheckInTest extends org.bonitasoft.connectors.alfresco34.AlfrescoConnectorTest {
    ...
    @Cover(classes = { CheckinConnector.class }, concept = BPMNConcept.CONNECTOR, jira = "ENGINE-580",
            story = "Tests a checkin with Alfresco", keywords = { "Alfresco", "Connector", "Checkin" })
    @Test
    public void checkIn() throws Exception {
        ...
        final String description = "upload file by path in check in test action";
        ...
        final Connector connector = this.getAlfrescoConnector(checkInInputs);
    ...
    protected AlfrescoConnector getAlfrescoConnector(final Map<String, Object> specificInputs) {
        final AlfrescoConnector connectorWithParams = new CheckinConnector();
